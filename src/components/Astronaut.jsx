...
export function Astronaut(props) {
  ...
  const ySpring = useSpring(yPosition, {damping:80});

  useEffect(() => {ySpring.set(props.position?.[1] || -1.2);
  }, [ySpring])
  ...
  return (
    <group ref={group} {...props} dispose={null} rotation={[-Math.PI / 2, -0.2, 2.2]} scale={props.scale || 0.3} position={props.position || [2.5,-1,-1]}>
