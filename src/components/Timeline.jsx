...
export const Timeline = ({
  ...
  return (
    <div
      ...
      ref={containerRef}>
     <h2 className="text-3xl font-bold md:text-4xl">My Study Experience</h2>
      <div ref={ref} className="relative pb-20">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
             ...
             <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:pl-20 md:text-4xl text-neutral-300">
                <h3>{item.date}</h3>
                <h3 className="text-3xl text-nuetral-400">{item.title}</h3>
                <h3 className="text-3xl text-nuetral-500">{item.job}</h3>
             </div>
            </div>
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-lavenedr/50 to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>
  );
